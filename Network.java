...
public class Network {
    ...
    *  Otherwise, creates a new user with the given name, adds the user to this network, and returns true. */
    public boolean addUser(String name) {
        ...
        userCount++;
        System.out.println("Success: User '" + name + "' has been added to the network.");
        return true;
    }
    ...
    public String mostPopularUser() {
        if (userCount == 0) {
            System.out.println("Error: The network has no users.");
            return null;
        }
        ...
        for (int i = 0; i < userCount; i++) {
            ...
            for (int j = 0; j < userCount; j++) {
                if (users[j].follows(currentUserName)) {
                    followerCount++;
                }
            }
        ...
        System.out.println("The most popular user is '" + mostPopular + "' with " + maxFollowers + " followers.");
        return mostPopular;
    }
